...
parser.add_argument('--seedsrandom', default=True,
...
parser.add_argument('--bestagentanimation', default=True,
...
parser.add_argument('--keepmodelhistory', default=True,
...
parser.add_argument('--architecturevary', default=False,
...
parser.add_argument('--batchnormalization', default=False,
    help='boolean defining batch normalization')
parser.add_argument('--noveltysearch', default=True,
